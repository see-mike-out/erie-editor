<script>
	...
	import Sound_4rnV3r from "$lib/example_sounds/erie-rec-4rnV3r.webm";
	import Sound_PfeSNG from "$lib/example_sounds/erie-rec-PfeSNG.webm";
	import Sound_Dz8CV6 from "$lib/example_sounds/erie-rec-Dz8CV6.webm";
	import Sound_iMDkYQ from "$lib/example_sounds/erie-rec-iMDkYQ.webm";
	import Sound_wg5AKy from "$lib/example_sounds/erie-rec-wg5AKy.webm";
	import Sound_1PXbW6 from "$lib/example_sounds/erie-rec-1PXbW6.webm";
	import Sound_mLgx50 from "$lib/example_sounds/erie-rec-mLgx50.webm";
...
<main>
	...
	<p>
		<a href="../../?ex=density-1&showVis=true" target="_blank">Open in the online editor</a>
	</p>
	<h2>Sonification</h2>
	<Player>
		...
		<p id="speech-TOeTvL" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Body Mass value is mapped to time. The duration of the stream is 3
			seconds
		</p>
		<p id="speech-5qm4QH" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Body Mass value is mapped to pan. The domains values from 2500 to 6500
			are mapped to
		</p>
		<section>
			<audio id="audio-4rnV3r" controls>
				<source src={Sound_4rnV3r} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-Q2ukfe" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Kernel density is mapped to pitch. The domains values from 1.654e-30
			to 0.001057 are mapped to
		</p>
		<section>
			<audio id="audio-PfeSNG" controls>
				<source src={Sound_PfeSNG} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		...
		<p id="speech-53AkCO" style="speech-rate: 315;" data-web-speech-rate="1.75">
			Start playing.
		</p>
		<section>
			<audio id="audio-Dz8CV6" controls>
				<source src={Sound_Dz8CV6} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		...
		<p id="speech-LHykUv" style="speech-rate: 315;" data-web-speech-rate="1.75">
			Start playing.
		</p>
		<section>
			<audio id="audio-iMDkYQ" controls>
				<source src={Sound_iMDkYQ} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		...
		<p id="speech-diwzc2" style="speech-rate: 315;" data-web-speech-rate="1.75">
			Start playing.
		</p>
		<section>
			<audio id="audio-wg5AKy" controls>
				<source src={Sound_wg5AKy} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		...
		<p id="speech-71zjgi" style="speech-rate: 315;" data-web-speech-rate="1.75">
			Start playing.
		</p>
		<section>
			<audio id="audio-1PXbW6" controls>
				<source src={Sound_1PXbW6} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		...
		<p id="speech-3YY2lm" style="speech-rate: 315;" data-web-speech-rate="1.75">
			Start playing.
		</p>
		<section>
			<audio id="audio-mLgx50" controls>
				<source src={Sound_mLgx50} type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-XIaCxf" style="speech-rate: 315;" data-web-speech-rate="1.75">
			Finished.
		</p>
	</Player>
