	...
	<Player>
		...
		<section>
			<audio id="audio-J3wSXW" controls>
				<source src="/example_sounds/erie-rec-J3wSXW.webm" type="audio/webm;codecs=opus" />
		...
		<section>
			<audio id="audio-XkyZTp" controls>
				<source src="/example_sounds/erie-rec-XkyZTp.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-TVz4IJ" style="speech-rate: 315;" data-web-speech-rate="1.75">Start playing.</p>
		<p id="speech-akWVGj" style="speech-rate: 180;" data-web-speech-rate="1" data-lang="en-US">A</p>
		<section>
			<audio id="audio-K18fJt" controls>
				<source src="/example_sounds/erie-rec-K18fJt.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-AwoRuy" style="speech-rate: 180;" data-web-speech-rate="1" data-lang="en-US">B</p>
		<section>
			<audio id="audio-XDQl3i" controls>
				<source src="/example_sounds/erie-rec-XDQl3i.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-9twmpB" style="speech-rate: 180;" data-web-speech-rate="1" data-lang="en-US">C</p>
		<section>
			<audio id="audio-6CwJce" controls>
				<source src="/example_sounds/erie-rec-6CwJce.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-y2kYpi" style="speech-rate: 180;" data-web-speech-rate="1" data-lang="en-US">D</p>
		<section>
			<audio id="audio-g39xw2" controls>
				<source src="/example_sounds/erie-rec-g39xw2.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-fb11iV" style="speech-rate: 180;" data-web-speech-rate="1" data-lang="en-US">E</p>
		<section>
			<audio id="audio-46Pjuh" controls>
				<source src="/example_sounds/erie-rec-46Pjuh.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-Xwaans" style="speech-rate: 315;" data-web-speech-rate="1.75">Finished.</p>
	</Player>
