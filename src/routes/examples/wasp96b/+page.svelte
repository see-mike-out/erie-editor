...
<main>
	...
	<p>
		Note: This is a replication of <a
			...
			target="_blank">Exoplanet WASP-96 b Sonification (NIRISS Transmission Spectrum)</a
		>.
	</p>
	<Player>
		...
		<p id="speech-JDc1bW" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Amount of Light Blocked (unit, parts per million) is mapped to loudness. The minimum value
			13585 is mapped to
		</p>
		<section>
			<audio id="audio-gXQSuk" controls>
				<source src="/example_sounds/erie-rec-gXQSuk.webm" type="audio/webm;codecs=opus" />
		...
		<section>
			<audio id="audio-KwsDDT" controls>
				<source src="/example_sounds/erie-rec-KwsDDT.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-yCLTcG" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Wavelength of Light (unit, microns) is mapped to pitch. The minimum value 0.619 is mapped
			to
		</p>
		<section>
			<audio id="audio-wGLRMQ" controls>
				<source src="/example_sounds/erie-rec-wGLRMQ.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		...
		<section>
			<audio id="audio-zwf8Kt" controls>
				<source src="/example_sounds/erie-rec-zwf8Kt.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-CkRxJe" style="speech-rate: 315;" data-web-speech-rate="1.75">Start playing.</p>
		<section>
			<audio id="audio-mQ3263" controls>
				<source src="/example_sounds/erie-rec-mQ3263.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-7GedkJ" style="speech-rate: 315;" data-web-speech-rate="1.75">Finished.</p>
	</Player>
