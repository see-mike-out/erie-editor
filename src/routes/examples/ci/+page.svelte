...
<main>
	...
	<Player>
		...
		<p id="speech-7iPgKK" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Petal Length is mapped to time. The duration of the stream is 2 seconds
		</p>
		<p id="speech-TpLvK6" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Predicted Sepal Length is mapped to pan. The domains values from −0.01037 to 8.158 are
			mapped to
		</p>
		<section>
			<audio id="audio-wIbQQk" controls>
				<source src="/example_sounds/erie-rec-wIbQQk.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-8XlPXS" style="speech-rate: 315;" data-web-speech-rate="1.75">
			The Predicted Sepal Length is mapped to pitch. The domains values from −0.01037 to 8.158 are
			mapped to
		</p>
		<section>
			<audio id="audio-FVlYPl" controls>
				<source src="/example_sounds/erie-rec-FVlYPl.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-0Fy4MJ" style="speech-rate: 315;" data-web-speech-rate="1.75">Start playing.</p>
		<section>
			<audio id="audio-sAupoE" controls>
				<source src="/example_sounds/erie-rec-sAupoE.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-j9d9fp" style="speech-rate: 315;" data-web-speech-rate="1.75">Finished.</p>
	</Player>
