...
<main>
	...
	<Player>
		...
		<p id="speech-Dk22A0" style="speech-rate: 315;" data-web-speech-rate="1.75">Start playing.</p>
		<section>
			<audio id="audio-XRI3Yk" controls>
				<source src="/example_sounds/erie-rec-XRI3Yk.webm" type="audio/webm;codecs=opus" />
				Your browser does not support the audio element.
			</audio>
		</section>
		<p id="speech-pvva4X" style="speech-rate: 315;" data-web-speech-rate="1.75">Finished.</p>
	</Player>
