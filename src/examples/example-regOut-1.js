...
export const ExRegOutput1 = {
  ...
  sonification: {
    ...
    datasets: [
      { name: 'qq', values: qq_data },
      { name: 'residuals', values: residual_data }
    ],
    synth: [{
      name: 'Fm1',
      type: 'FM'
    ...
    sequence: [{
      ...
      transform: [{
        calculate: "(datum.residual + 2.477468)/(2.495122 + 2.477468)", as: "normalized"
      }, {
        calculate: "(datum.normalized - datum.normalQuantile)", as: "deviation"
      }],
      tone: {
        continued: false
      },
